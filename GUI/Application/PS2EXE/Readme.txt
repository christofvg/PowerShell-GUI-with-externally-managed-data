...
Update v0.5.0.16 - 2019-07-01
- new parameter -noOutput: the resulting executable will generate no standard output (includes verbose and information channel)
- new parameter -noError: the resulting executable will generate no error output (includes warning and debug channel)
- new parameter -supportOS: use functions of newest Windows versions (execute [Environment]::OSVersion to see the difference)
...
Update v0.5.0.15 (2019-04-30):
- introduction of graphical GUI "Win-PS2EXE"
